...
* [MDS](https://github.com/ichensky/mds) - Сollection of audio books known as `MDS`. Client side app. Contains examples of components for data pagination, filtration. ([Demo](http://x-mds.azurewebsites.net)).
